...
?>
  ...
  <div class="flex flex-col w-full">
    ...
    <input type="password" name="password" aria-label="Password" class="input-field border-2 border-zinc-400/80 p-2 rounded !appearance-none bg-transparent  focus:!outline-none focus:ring-2 focus:ring-green-400 z-10  <?php
